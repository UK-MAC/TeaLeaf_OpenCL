// automaticllly generated from makefile
const static std::string src_accelerate_cl("__kernel void accelerate\n\
(double dbyt,\n\
...
");
const static std::string src_advec_cell_cl("\n\
...
");
const static std::string src_advec_mom_cl("\n\
...
\n\
");
const static std::string src_calc_dt_cl("\n\
...
\n\
");
const static std::string src_field_summary_cl("\n\
...
\n\
");
const static std::string src_flux_calc_cl("__kernel void flux_calc\n\
(double dt,\n\
 __global const double * __restrict const xarea,\n\
 __global const double * __restrict const yarea,\n\
 __global const double * __restrict const xvel0,\n\
...
\n\
");
const static std::string src_generate_chunk_cl("\n\
...
\n\
");
const static std::string src_halo_bare_cl("\n\
...
\n\
");
const static std::string src_ideal_gas_cl("\n\
...
\n\
");
const static std::string src_initialise_chunk_cl("\n\
...
\n\
");
const static std::string src_macros_cl("#pragma OPENCL EXTENSION cl_khr_fp64 : enable\n\
\n\
...
\n\
");
const static std::string src_PdV_cl("\n\
...
\n\
");
const static std::string src_reduction_cl("#ifdef cl_khr_fp64\n\
...
\n\
");
const static std::string src_reset_field_cl("\n\
...
\n\
");
const static std::string src_revert_cl("\n\
...
\n\
");
const static std::string src_update_halo_cl("#undef __kernel_indexes\n\
    #define __kernel_indexes                            \\\n\
        const int column = get_global_id(0);         \\\n\
        const int row = get_global_id(1);            \\\n\
        const int loc_column = get_local_id(0);      \\\n\
...
\n\
");
const static std::string src_viscosity_cl("\n\
